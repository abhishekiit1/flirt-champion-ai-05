	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-passionate': 'var(--gradient-passionate)',
				'gradient-dreamy': 'var(--gradient-dreamy)',
				'gradient-soft': 'var(--gradient-soft)',
				'gradient-roast': 'var(--gradient-roast)',
				'gradient-savage': 'var(--gradient-savage)'
			},
			boxShadow: {
				'romantic': 'var(--shadow-romantic)',
				'passionate': 'var(--shadow-passionate)',
				'soft': 'var(--shadow-soft)',
				'roast': 'var(--shadow-roast)'
			},
			borderRadius: {
				lg: 'var(--radius)',
